...
static std::size_t dunavant_order_num(std::size_t);
static std::vector<std::size_t> dunavant_suborder(int, int);
static std::size_t dunavant_suborder_num(int);
static void dunavant_subrule(std::size_t, std::size_t, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_01(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_02(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_03(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_04(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_05(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_06(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_07(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_08(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_09(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_10(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_11(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_12(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_13(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_14(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_15(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_16(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_17(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_18(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_19(int, std::vector<double>&, std::vector<double>&);
static void dunavant_subrule_20(int, std::vector<double>&, std::vector<double>&);
static int i4_modp(int, int);
static int i4_wrap(int, int, int);
static void legendre_compute_glr(std::size_t, std::vector<double>&, std::vector<double>&);
static void legendre_compute_glr0(std::size_t, double&, double&);
static void legendre_compute_glr1(std::size_t, std::vector<double>&, std::vector<double>&);
...
//-----------------------------------------------------------------------------
static void dunavant_subrule_01(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_02(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_03(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_04(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_05(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_06(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_07(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_08(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_09(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_10(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_11(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_12(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_13(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_14(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_15(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_16(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_17(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_18(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_19(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void dunavant_subrule_20(int suborder_num, std::vector<double>& suborder_xyz,
					    std::vector<double>& suborder_w)
...
static void legendre_compute_glr0(std::size_t n, double& p, double& pp)
...
static void legendre_compute_glr1(std::size_t n_,
					      std::vector<double>& x,
					      std::vector<double>& w)
...
//
{
  ...
  t = 0.0;
  x1 = rk2_leg(t, -3.141592653589793238462/2.0, 0.0, n);
...
RuleRef tetra_rule_keast(std::size_t order)
{
  ...
  if (e.second.empty())
  {
    ...
    case 1:
      ...
      break;
    case 2:
      pts = {{0.585410196624969, 0.138196601125011, 0.138196601125011},
    ...
    case 3:
      pts = {{0.25,    0.25,    0.25   },
             ...
             {1./6.,   0.5,     1./6.  },
             {0.5,     1./6.,   1./6.  }};
      w   = {(-4./5.)/6.0, (9./20.)/6.0, (9./20.)/6.0, (9./20.)/6.0, (9./20.)/6.0};
      break;
    case 4:
      pts = {{0.25,                    0.25,                    0.25                   },
      ...
      break;
    case 5:
      pts = {{0.0927352503108910, 0.0927352503108910, 0.0927352503108910},
    ...
    for (std::size_t i = 0; i < n; ++i)
    {
      e.first[3*i + 0] = pts[i].r;
      e.first[3*i + 1] = pts[i].s;
